var AllDishesView = function (container, model) {    
        ...
        for (key in allDishes) {
            dishes = '<div class="col-md-3" name="dish" id="a'+ allDishes[key].id +'"><div class="thumbnail"><img src="images/' + allDishes[key].image + '" style="width:100%"><div class="caption"><p id="dishName">' + allDishes[key].name + '</p></div></div></div>';       
